...
/// FeedActivity
let exampleFeedActivity = FeedActivity(
    id: "",
    ...
    bookmarks: 40,
    activities: [exampleActivity2]
)
let sunsetBeachActivity = FeedActivity(
    id: "beach-sunset",
    title: "Sunset at the Beach",
    date: Date().addingTimeInterval(-600), // simulate 10 minutes ago
    images: [
...
let mountainHikeActivity = FeedActivity(
    id: "mountain-hike",
    title: "Mountain Hike with Friends",
    date: Date().addingTimeInterval(-3600), // simulate 1 hour ago
    images: [
